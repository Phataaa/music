    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <button class="btn btn-outline-success my-2 my-sm-0" id ="login"><a href="">Login</a></button>
                <button class="btn btn-outline-success my-2 my-sm-0" id ="register"><a href="">Register</a></button>
            </div>
            <div>
